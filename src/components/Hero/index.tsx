...
const Hero = () => {
  ...
  />*/}
        ...
        <div className="z-10 table h-full w-full relative max-w-[1280px] m-auto text-left">
          ...
          <div className=" table-cell align-middle">
            <div className="max-w-[984px] my-0 mx-auto relative">
              <div className="w-full h-full absolute top-[-3%] left-[-3%] bg-cover">
                <div className="z-50 rounded-full h-[50px] w-[50px] bg-[#13144d]l bg-[#00a0e9] from-[#d1d8db] bg-gradient-to-tr"></div>
              </div>
          ...
          <div className=" table-cell align-middle">
            <div className="max-w-[984px] my-0 mx-auto">
              ...
              <ul className="top-[4px] w-1/2 float-right pl-[20px] relative">
                <li className="mb-[33px] pb-[33px] clear-both border-b border-solid border-[#ddd]">
                  <h3 className=" text-lg pb-0 float-left text-[#00a0e9] font-bold">
                    Professionalism
                  </h3>
                  <p className="pl-[166px]">
                    <strong className="text-lg pb-0 font-bold block text-black">
                      <i>No.</i>1&nbsp;  Ad-Tech Startup
                    </strong>
                    <span>
                      글로벌 디지털 영상 광고 시장을 선도
                    </span>
                  </p>
                </li>
                <li className="mb-[33px] pb-[33px] clear-both border-b border-solid border-[#ddd]">
      ...
      <div className="relative overflow-hidden h-screen w-full bg-black">
        ...
        */}
      {/** 4th section */}
      <div className="relative overflow-hidden h-screen w-full bg-[#efeeea]l bg-[#13144d]">
        {/** 4th-section cont */}
        <div className="table h-full w-full relative max-w-[1280px] m-auto text-left">
          <div className="table-cell align-middle">
            <div className="table table-fixed w-full relative top-[30px]">
              ...
              <div className="pl-[22px] table-cell w-1/2 align-middle text-white">
        ...
        <div className="table h-full w-full relative max-w-[1280px] m-auto text-left">
            <div className="table-cell align-middle">
              <div className="top-[-29px] relative max-w-[984px] my-0 mx-auto">
                <div className="w-full h-full absolute top-[-20%] left-[-3%] bg-cover">
                  <div className="z-50 rounded-full h-[50px] w-[50px] bg-[#13144d]l bg-[#00a0e9] from-[#d1d8db] bg-gradient-to-tr"></div>
                </div>
                ...
                <ul className="top-[-8px] relative">
                  <li className="float-left w-1/2 text-white]">
                    <h3 className="pb-[11px] text-sm font-semibold text-[#00a0e9]">
                      Contact
                    </h3>
                    <p className="pb-[20px] w-[390px] text-[22px] font-semibold">
                      최적의 광고를 위한 멋진 시작
                    </p>
                    <Link href="/contact" className=" text-base inline-block relative align-middle text-left min-w-[150px] py-[20px] pr-[25px] pl-[3px] font-normal">
                      <span className="top-[-1px] relative font-semibold">문의하기</span>
                      <span aria-hidden="true" className="pl-[10px] hover:pl-[22px] relative transition-all">→</span>
                    </Link>
                  </li>
                  <li className="float-right w-1/2 text-white]">
                    ...
                    <Link href="/career" className=" text-base inline-block relative align-middle text-left min-w-[150px] py-[20px] pr-[25px] pl-[5px] font-normal">
